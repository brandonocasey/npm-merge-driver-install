...
Automatically merge package manager lockfiles during git merges. Supports npm, pnpm, yarn, bun, and deno. Heavily based on [npm-merge-driver](https://www.npmjs.com/package/npm-merge-driver) with automated setup at package install time and a single small dependency for ci checking.
...
* `npm-merge-driver-merge`: the internal merge binary used to merge lockfiles (automatically detects package manager)
