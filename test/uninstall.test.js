...
test.beforeEach(async (t) => {
  ...
  t.context.uninstall = (options) =>
    uninstall(t.context.dir, {
...
test("can uninstall", (t) => {
  ...
  t.is(exitCode, 0);
  t.deepEqual(t.context.logs.sort(), ["uninstalled successfully"].sort());
});
...
if (os.platform() !== "win32") {
  test("uninstalls if run as binary", (t) => {
    return promiseSpawn(path.join(BASE_DIR, "src", "uninstall.js"), [], { cwd: t.context.dir }).then((result) => {
      t.false(isInstalled(t.context.dir));
...
test("uninstalls if run with node", (t) => {
  return promiseSpawn("node", [path.join(BASE_DIR, "src", "uninstall.js")], { cwd: t.context.dir }).then((result) => {
    t.false(isInstalled(t.context.dir));
    t.is(result.exitCode, 0);
    t.is(result.stderr, "");
    t.is(result.stdout, "npm-merge-driver-install: uninstalled successfully\n");
